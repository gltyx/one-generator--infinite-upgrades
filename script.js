...
function updateDisplay(){
  ...
  showIf("autoBuy2",function(){return game.upgrades.strongerGenerators12.gte(6);});
  showIf("strongerGenerators13",function(){return game.upgrades.autoBuy2.gte(ExpantaNum.ONE);});
